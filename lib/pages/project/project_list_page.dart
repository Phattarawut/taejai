...
class _ProjectListPageState extends State<ProjectListPage> {
  List<Project> projects = [
    ...
    Project(
      ...
      area: 'ระบุพื้นที่: ภาคตะวันออกเฉียงเหนือ ภาคตะวันตกและภาคใต้ของประเทศไทย',
      imageUrl:
          'assets/images/project02.jpg',
    ),
    Project(
      ...
      area: 'ระบุพื้นที่: ตำบลลานสัก อำเภอลานสัก จังหวัดอุทัยธานี (เขตรักษาพันธุ์สัตว์ป่าห้วยขาแข้งและพื้นที่โดยรอบ), ตำบลไชยมงคล อำเภอเมืองนครราชสีมา จังหวัดนครราชสีมา (สวนสัตว์นครราชสีมา)',
      imageUrl:
          'assets/images/project03.jpg',
    ),
  ];
